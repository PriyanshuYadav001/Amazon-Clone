...
import { addToCart } from "../../Components/Redux/Actions/actions";
      ...
      <div className="productsPageMain">
        ...
        <div className="productsPageMainRight">
          <div className="productsPageMainRightTopBanner">
            ...
            <span className="productsPageMainRightTopBannerSpan">Laptops</span>
          </div>

          <div className="itemsImageProductPage">
            {productDetail.product.map((item, idx) => {
              return (
